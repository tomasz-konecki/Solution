...
const validateInput = (inputValue, canBeNull, minLength, maxLength, inputType, inputTitle) => {
    const { t } = (this.props);
    if (!canBeNull && inputValue.length === 0) {
        return t("Wartość pola ") + inputTitle + " nie może być pusta";
    }
...
export default translate("validateInput")(validateInput);
