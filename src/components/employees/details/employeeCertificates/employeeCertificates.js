...
class EmployeeCertificates extends React.Component{
    ...
    render(){
        const {certificates, t } = this.props;

        return (
            <div className="emp-table">
                <h2>{t("Title")}
                    <span>
                        <i onClick={this.addCertificateModal} className="fa fa-plus"></i>
                    </span>
                </h2>
                            ...
                            return (
                                <tr key={certificate.id}>
                                    ...
                                    <td className="options">
                                        <div onClick={() => this.editCertificate(certificate)} title={t("Edit")} className="option"><Icon icon="pen-square"/></div>
                                        <div onClick={() => this.props.deleteCertificate(certificate, t("Deleting", t("SuccesfullDelete")))} title={t("Delete")} className="option"><Icon icon="minus-square" /></div>
                                    </td>
                                </tr>
                            );
                        })}
