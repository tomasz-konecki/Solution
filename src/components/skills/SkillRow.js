...
class SkillRow extends Component {
  ...
  standardiseSkill(object) {
    ...
    object.skillName === undefined
      ? (skill.skillName = object.name)
      : (skill.skillName = object.skillName);
    object.skillLevel === undefined
      ? object.level !== undefined
        ? (skill.skillLevel = object.level)
        : (skill.skillLevel = 1)
      : (skill.skillLevel = object.skillLevel);
    object.skillId === undefined
      ? (skill.skillId = object.id)
      : (skill.skillId = object.skillId);
  ...
  rowLevels = () => {
    return (
      <div className="skill-row-levels">
  ...
  rowEditLevels = () => {
    return (
      <div className="skill-row-levels-editor">
        <input
          type="range"
          min="1"
          max="5"
  ...
  pullYoeDOM = skill => {
    return (
      <span>
        ...
        <div className="skill-row-yoe">
          {this.years(skill.yearsOfExperience)}
        </div>
        {this.props.editable ? (
